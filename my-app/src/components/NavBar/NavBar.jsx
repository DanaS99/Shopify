...
const NavBar = () => {
    ...
    const { searchParam, setSearchParam, handleSubmit, notFound } = useContext(GlobalContext);
    ...
    return (
      <div>
        <header className='flex justify-between items-center px-5 xl:px-24 pt-9 lg:px-2 pb-3 lg:mx-0'>
            ...
            {isSearchOpen && (
                <div className='fixed top-0 left-0 right-0 flex justify-center h-32 items-start bg-white p-4 z-50'>
        ...
        <div>
           ...
           {notFound && (
                <div className='w-full text-center mt-4'>
                    <p className='text-red-600'>The item you mentioned is not found in our store.</p>
                </div>
            )}
        </div>
        </div>
